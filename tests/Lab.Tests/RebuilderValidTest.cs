...
public class RebuilderValidTest
{
        ...
        Psu anotherPsu)
    {
        ...
        IComputer anotherPersonalComputer = new PersonalComputerDebuilder(personalComputer)
            .AnotherPsu(anotherPsu)
            .Rebuild();

        // Assert
        Assert.NotNull(anotherPersonalComputer);
    }
}