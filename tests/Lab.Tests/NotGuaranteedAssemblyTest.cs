...
public class NotGuaranteedAssemblyTest
{
        ...
        Psu psu)
    {
        ...
        // Act and Assert
        GuaranteeException ex = Assert.Throws<GuaranteeException>(() =>
        {
        ...
        // Assert
        Assert.Equal("Cooling system tdp is lower than cpu tdp", ex.Message);
    }
}