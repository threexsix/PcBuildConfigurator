...
public class InvalidGpuAssemblyTest
{
        ...
        Psu anotherPsu)
    {
        ...
        // Act
        MismatchAssemblyException ex = Assert.Throws<MismatchAssemblyException>(() =>
        {
        ...
        // Assert
        Assert.Equal("GPUs do not fit the PC case", ex.Message);
    }
}